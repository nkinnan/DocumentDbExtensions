# DocumentDbRetryHandlerError Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Microsoft.Azure.Documents.DocumentDbRetryHandlerError<br />
...
``` VB
<SerializableAttribute>
Public Class DocumentDbRetryHandlerError
	Inherits Exception
```
...
``` C++
[SerializableAttribute]
public ref class DocumentDbRetryHandlerError : public Exception
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type DocumentDbRetryHandlerError =  
    class
        inherit Exception
    end
```

The DocumentDbRetryHandlerError type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="4c5d533d-7da1-ee13-8c18-4905d837a821">DocumentDbRetryHandlerError</a></td><td>
The constructor.</td></tr></table>&nbsp;
<a href="#documentdbretryhandlererror-class">Back to Top</a>
