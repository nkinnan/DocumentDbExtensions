# DocumentDbExtensions.ExecuteQueryWithContinuationAndRetry(*TElement*) Method 
...
**C#**<br />
``` C#
public static IList<TElement> ExecuteQueryWithContinuationAndRetry<TElement>(
...
**VB**<br />
``` VB
Public Shared Function ExecuteQueryWithContinuationAndRetry(Of TElement) ( 
...
static IList<TElement>^ ExecuteQueryWithContinuationAndRetry(
	IQueryable<TElement>^ queryable, 
...
**F#**<br />
``` F#
static member ExecuteQueryWithContinuationAndRetry : 
