# DocumentDbUnexpectedResponse Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Microsoft.Azure.Documents.DocumentDbUnexpectedResponse<br />
...
``` VB
<SerializableAttribute>
Public Class DocumentDbUnexpectedResponse
	Inherits Exception
```
...
``` C++
[SerializableAttribute]
public ref class DocumentDbUnexpectedResponse : public Exception
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type DocumentDbUnexpectedResponse =  
    class
        inherit Exception
    end
```

The DocumentDbUnexpectedResponse type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="f6cee140-4e4f-cc4e-3c3f-bb66b6a79b2b">DocumentDbUnexpectedResponse</a></td><td>
The constructor.</td></tr></table>&nbsp;
<a href="#documentdbunexpectedresponse-class">Back to Top</a>
