# DocumentDbRetriesExceeded Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Microsoft.Azure.Documents.DocumentDbRetriesExceeded<br />
...
``` VB
<SerializableAttribute>
Public Class DocumentDbRetriesExceeded
	Inherits Exception
```
...
``` C++
[SerializableAttribute]
public ref class DocumentDbRetriesExceeded : public Exception
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type DocumentDbRetriesExceeded =  
    class
        inherit Exception
    end
```

The DocumentDbRetriesExceeded type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="01edf9a6-cfac-7d27-1766-c5b673c2d224">DocumentDbRetriesExceeded</a></td><td>
The constructor.</td></tr></table>&nbsp;
<a href="#documentdbretriesexceeded-class">Back to Top</a>
