# DocumentDbExtensions.ExecuteFeedWithContinuationAndRetry(*R*) Method (Func(String, FeedResponse`1(*R*)), EnumerationExceptionHandler, FeedResponseHandler, Nullable(Int32), Nullable(TimeSpan), ShouldRetry)
